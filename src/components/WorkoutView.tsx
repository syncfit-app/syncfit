    ...
    <div className="w-full max-w-6xl mx-auto space-y-6 pb-8 pt-0">
      ...
      <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm space-y-3">
        <div className="flex items-center justify-between px-1">
          ...
          <span className="text-[11px] font-bold text-slate-400">4 Hari Latihan / Minggu</span>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-extrabold text-[#111827] text-base flex items-center gap-2">
                Cardio Finisher
                <span className="bg-[#111827] text-white text-[9px] uppercase px-2 py-0.5 rounded-md">Opsional</span>
              </h3>
