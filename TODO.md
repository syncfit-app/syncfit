...
|---|---|---|---|---|---|
| B2 | Update XP & streak setelah sesi selesai | Workout Page / Gamifikasi | Todo | 1 (berikutnya) | Formula disepakati: **+2 XP per set selesai**. Streak berbasis jarak antar-sesi (`expected_gap = ceil(7/days)` hari), bukan kalender minggu — direset kalau jeda antar sesi melebihi itu |
